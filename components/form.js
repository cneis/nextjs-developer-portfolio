        ...
        <dl>
          ...
          <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
              ...
              Ich suche Projekte als Freelancer oder eine Teilzeit-Anstellung, 100% remote.
            </dd>
          </div>
          <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            <dt className="text-sm font-medium text-gray-500">Skills</dt>
            <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                Meine Vorlieben sind Frontend-Development in html / css oder in react / next, Backend mit node.js. Datenanbindungen aus sql- / nosql-Datenbanken, aus headless cms oder api sind kein Problem. <br />
