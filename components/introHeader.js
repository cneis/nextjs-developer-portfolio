        ...
        <header className='px-6 py-14'>
            <div className='max-w-4xl mx-auto flex gap-14 items-center flex-col-reverse md:flex-row drop-shadow-md hover:drop-shadow-xl'>
                <div>
                    ...
                    <Link href='/work'>
                        <a className='inline-block bg-myblue-100 text-white px-6 py-3 text-lg rounded drop-shadow-md hover:drop-shadow-xl duration-700 hover:scale-110'>Check my work</a>
                    </Link>
