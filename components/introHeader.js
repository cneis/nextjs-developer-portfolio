        ...
        <header className='px-6 py-14'>
            <div className='max-w-4xl mx-auto flex gap-14 items-center flex-col-reverse md:flex-row'>
                <div>
                    ...
                    <a href='/work' className='inline-block bg-myblue-100 text-white px-6 py-3 text-lg rounded drop-shadow-md hover:drop-shadow-xl duration-700 hover:scale-110'>Check my work</a>
                </div>
                <span className='m-5 inline-block before:w-full before:aspect-square before:block before:absolute before:-left-1.5 before:top-1.5 before:bg-myblue-100 relative before:block before:absolute before:bg-red-400 relative z-0 before:rounded-full'>
