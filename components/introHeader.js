    ...
    return (
        <header className='px-6 py-14'>
            <div className='max-w-4xl mx-auto flex gap-14 items-center flex-col-reverse md:flex-row drop-shadow-md '>
                <div>
                    <h1 className='text-3xl font-bold mb-6'>Ich bin Christopher, <br />Software Developer</h1>
                    ...
                    <Link href='/contact'>
                        <a className='inline-block bg-sky-500 text-white px-6 py-3 text-lg rounded drop-shadow-md hover:drop-shadow-xl duration-700 hover:scale-110'>Check my skills</a>
                    </Link>


                </div>
                <Link href='/contact'>
                <span className='m-5 inline-block 
                        before:w-full before:aspect-square before:block before:absolute 
                        before:-left-1.5 before:top-1.5 before:bg-myblue-100 
                        relative 
                        ...
                        before:rounded-full
                        cursor-pointer
                        hover:drop-shadow-xl duration-700 hover:scale-110'
                        >
